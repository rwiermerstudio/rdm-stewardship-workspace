...
- In oral histories, a researcher can reach training responses from three roles, but community discoverability, recording requests and actual consent terms remain outside this exercise. The neighbourhood and brain cases also end with named unresolved consent or inspection checks. The astronomy curator can record a package observation, not acceptance. Unknown genomic consent and coastal location risk cannot reach a curator action.
